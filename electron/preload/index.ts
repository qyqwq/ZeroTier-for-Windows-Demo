...
contextBridge.exposeInMainWorld('nodeAPI', {
  readZerotierToken: () => ipcRenderer.invoke('readZerotierToken'),
  requestApi: (option) => ipcRenderer.invoke('requestApi', option),
  installZero: () => ipcRenderer.invoke('installZero'),
